...
const Introduction = ({ t }: LangType) => {
    ...
    return (
        <section className="flex flex-col justify-between md:justify-around items-center h-full md:flex-row">
            <div className="flex flex-col justify-between lg:justify-around items-center gap-10 md:gap-0 md:items-start w-full">
                ...
                <h1 className="text-orange-400 text-[35px] md:text-3xl xl:text-5xl opacity-70 text-center md:mb-[24px]">Full Stack Developer</h1>
                {renderSocialMediaItems()}
                <span className="hidden md:block h-[61px]"></span>
                <div className="flex justify-between gap-4 mb-0 md:mb-[80px]">
                    <Button className="flex justify-center gap-2 bg-orange-500 text-white border-2 border-orange-400 p-4">
                        <FaWhatsapp size={20} />
