...
const CustomTabs = ({ t } : LangType) => {
    return (
        <Tabs defaultValue="all" className="w-full gap-16 lg:gap-4">
            <TabsList className="grid grid-cols-3 lg:grid-cols-4 justify-between gap-2 w-full bg-gray-950 [&>*]:capitalize [&>*]:text-white [&>*]:border [&>*]:border-orange-400 [&>*]:bg-neutral-900 [&>*]:cursor-pointer [&>*]:px-4 [&>*]:py-2 [&>*]:w-[250px]">
